    ...
    for plot_name in plot_names:
        ...
        for i, plot_config in enumerate(plot_config_list):
            ...
            slider = Slider(
                ...
                label="Iteration",
                valmin=0,
                valmax=len(variation_map) - 1,
                valinit=0,
                valstep=1,
            )

            def update(_: float):
                variation = variation_map[slider.val]
                results = parameterized_grid[variation]
                plot_grid.update_grid(
                    fig,
                    axes,
                    plt_lines,
                ...
                slider.valtext.set_text("{variation}")
